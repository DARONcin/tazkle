...
- Product mark: `design/approved/brand/tazkle-mark.svg`.
- Wordmark: `design/approved/brand/tazkle-wordmark.svg`.
...
| `accent.primary` | `#4F7CFF` | Primary action and selection |
| `accent.relation` | `#8C6BFF` | Relationships and architecture |
| `accent.proposal` | `#6DD6E7` | Tazki proposals and alternatives |
| `accent.caution` | `#F1B84B` | Cost, risk, pending decision |
